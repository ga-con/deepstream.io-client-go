...
//EventInvalidAuthData happens when invalid credentials provided
const EventInvalidAuthData = "INVALID_AUTH_DATA"

//EVENT.AUTH_ATTEMPT	AUTH_ATTEMPT	✔
//EVENT.AUTH_ERROR	AUTH_ERROR	✔

//EventTooManyAuthAttempts happens when the server won't allow any more auth attempts
const EventTooManyAuthAttempts = "TOO_MANY_AUTH_ATTEMPTS"
